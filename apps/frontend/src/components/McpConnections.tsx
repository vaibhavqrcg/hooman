...
export const McpConnections = forwardRef<McpConnectionsHandle>(
  function McpConnections(_props, ref) {
    ...
    function startEdit(c: MCPConnection) {
      ...
      if (c.type === "stdio") {
        ...
        const o = (c as MCPConnectionHosted | MCPConnectionStreamableHttp)
          .oauth;
        setOAuthEnabled(!!o);
